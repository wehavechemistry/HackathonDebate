...
IMPORTANT: End your response with exactly these two lines (no extra text):
USER_SCORE: [user total score as number]/40
AI_SCORE: [AI opponent total score as number]/40`;
}
